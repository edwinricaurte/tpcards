! function(e, t) {
    ...
    const H = "SweetAlert2:",
        ...
        r = {
            ...
            closeButtonAriaLabel: "Cerrar dialogo",
            loaderHtml: "",
    ...
    const c = {
        ...
        je = (e, t) => {
            var n, o, i, a, r, s = y(),
                c = d();
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? B : x)(s), C(s, t, "actions"), s = s, n = c, o = t, i = h(), a = f(), r = b(), Me(i, "confirm", o), Me(a, "deny", o), Me(r, "cancel", o),
                function(e, t, n, o) {
    ...
    const Dt = e => {
        ...
        Nt = (e, n, t) => {
            ...
            if (o && (!n.isComposing && 229 !== n.keyCode))
                if (o.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key) e = e, s = n, i = o, R(i.allowEnterKey) && s.target && e.getInput() && s.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(i.input) || (It(), s.preventDefault()));
                else if ("Tab" === n.key) {
                    e = n;
                    var i = o;
                    var a = e.target,
    ...
    const Jt = (e, t) => {
        ...
        Xt = (t, n) => {
            ...
            if (e.showLoaderOnDeny && I(f()), e.preDeny) {
                ...
                o.then(e => {
                    !1 === e ? (t.hideLoading(), Ft(t)) : t.closePopup({
                        isDenied: !0,
                        value: void 0 === e ? n : e
                    })
    ...
    const hn = (l, u, d) => new Promise((e, t) => {
            ...
            Mt.swalPromiseResolve.set(l, e), Mt.swalPromiseReject.set(l, t), u.confirmButton.onclick = () => {
                ...
                capture: e.keydownListenerCapture
            }), e.keydownHandlerAdded = !0), a = l, "select" === (t = d).input || "radio" === t.input ? Et(a, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (U(t.inputValue) || F(t.inputValue)) && (I(h()), Tt(a, t)); {
                var r = d;
                const s = m(),
                    c = g();
        ...
        }), D.DismissReason = j, D.version = "11.4.11", D);
